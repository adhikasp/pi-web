...
export class ChatView extends LitElement {
  ...
  private shouldFallbackToBottomForMissingAnchor(): boolean {
    // While stream state is being reconstructed after a mid-stream reconnect,
    // history can temporarily omit the in-flight assistant message that a
    // previous scroll save anchored to. Keep retrying until the transcript
    // has a chance to render that anchor.
